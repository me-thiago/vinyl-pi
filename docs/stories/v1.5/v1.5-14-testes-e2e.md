...
Não existem testes E2E atualmente:
...
Testes unitários não capturam problemas de integração entre frontend e backend.
...
- [ ] Task 2: Criar testes de navegação
  - [ ] Teste: Carregar página inicial
...
- [ ] Task 3: Criar testes do Player
  ...
  - [ ] Teste: Botão play/pause funciona
  - [ ] Teste: Controle de volume funciona

- [ ] Task 4: Criar testes de Settings
  - [ ] Teste: Carregar configurações atuais
  - [ ] Teste: Alterar tema
...
- [ ] Task 5: Integrar com CI
  ...
  - [ ] Configurar sharding se necessário
...
test.describe('Player', () => {
  ...
  test('should toggle play/pause', async ({ page }) => {
    ...
    // Após clicar, deve mostrar pause
